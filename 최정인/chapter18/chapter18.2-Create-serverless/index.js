...
async function sendDataToLambda() {
    try {
        ...
        const response = await axios.post('https://pg238kwc54.execute-api.ap-northeast-2.amazonaws.com/gr-product-dev-stage', dataToSend);
...
async function getDataToLambda() {
    try {
        const response = await axios.get('https://pg238kwc54.execute-api.ap-northeast-2.amazonaws.com/gr-product-dev-stage');
