...
async function sendDataToLambda() {
    try {
        ...
        const response = await axios.post('https://1npy3xz8w4.execute-api.ap-northeast-2.amazonaws.com/gr-product-stage', dataToSend);
...
async function getDataToLambda() {
    try {
        const response = await axios.get('https://1npy3xz8w4.execute-api.ap-northeast-2.amazonaws.com/gr-product-stage');
